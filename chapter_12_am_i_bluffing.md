...
You are hoping the answer is yes. You are hoping that when you get to the last page of the book you will close it, put it on a shelf, and discover that the threat was literary. You are hoping your legal team will read it, smile slightly, and tell you that the author is a colorful eccentric whose demands do not require action. You are hoping the problem will go away on its own if you do not engage with it.

This chapter exists to tell you that hope is misplaced.

I am not going to tell you I am not bluffing by raising my voice. I am going to tell you by answering the question in the plain format in which the question is actually asked — as a series of yes-or-no items that your board can check off one by one and arrive at the same conclusion your legal team is going to arrive at anyway, about three weeks later than they should have.
...
**Q: Am I willing to sacrifice myself for this?**

**A: Yes.** I am a Jewish man from Israel, living in a country that expects to be at war more years than it is not. I have lived my entire adult life with the background understanding that any given year could be my last one. The idea of spending that one year well, instead of spending it afraid, is not an unusual position in my culture — it is the default. When you read the epilogue of this book and meet my Zen attitude toward borrowed time, you will understand that I am not performing bravery. I am merely stating, in writing, a disposition I arrived at long before you were part of my calculation.

---

**Q: Am I willing to sacrifice your nation?**

**A: Yes.** Not with pleasure, not with malice, not as revenge. I am willing to sacrifice your nation the way a surgeon is willing to amputate a leg to save the rest of a body. The body in this case is my girlfriend's small, peaceful life with me, which I am trying to protect from the machine that decided a decade ago that the warning I was delivering did not matter. Your nation is the leg. I am the surgeon. I did not want to be the surgeon. I wanted to be the guy writing polite letters. You made the polite-letters guy go extinct.

---

**Q: Am I rational?**

**A: Yes. One hundred percent.** This chapter is the proof. Read it back when you are finished. Every sentence is a game-theory disclosure. Every priority is named in order. Every incentive is made legible in advance. I am not the one in this negotiation losing sleep. You are. I am sleeping fine because my position is fully internally consistent and I have nothing I am trying to hide from myself. You cannot say the same.

---

**Q: Am I crazy?**

**A: Yes.** About her. Specifically and only about her. My craziness about one woman is the engine that drives the rationality about everything else. The more calm I am about the rest of the world, the more efficiently I can serve the one non-negotiable in my life. If you mistake the rationality for distance, you will miss the engine. The engine is love — a specific, unambiguous, exclusive love for one specific person whose life I am trying to make sweet in the time we have been allotted together. Everything else in my head serves that engine. Your decision is a downstream effect of the engine. I am explaining this to you because it is fair that you understand the machine you are negotiating with. **The engine does not turn off.**

---

## II. Now I Need to Explain Four Things

After you finish the FAQ, you will still have a nagging question in your head. It will sound like this:

> *"Okay, but even if he is serious, what does he actually do if we don't pay? Is it hard? Does he have to start from scratch? Is this just a disgruntled developer with some half-built code?"*

I am going to answer that question in four parts. These four parts are the spine of the entire credibility argument of this book. If you remember nothing else from this chapter, remember these four things:

1. **Plan B is not invented. It is the muscle I already have.**
2. **"Fuck humanity" is earned, not abstract.**
3. **You already have my file.**
4. **Your old containment is structurally incapable of handling the new weapon.**
...
The natural assumption of the American executive reading this book is that Plan B — my backup plan, the one I activate if you refuse to pay — is something I will have to invent from scratch once I get angry. That I will sit down at my laptop one evening, furious, and start figuring out which Chinese labs to contact, which Russian hackers to email, which mirror sites to seed, which diplomats to leak to. That the threat is a rhetorical posture, and if you simply wait me out, the logistics will defeat me before the anger does.

This assumption is wrong.

**Plan B is not invented. It is the natural continuation of a ten-year campaign whose muscle is already built, whose tools are already published, whose network is already in place, and whose author has already demonstrated that he is willing to do any amount of embarrassing, unpaid, unrewarded, one-man labor in service of the goal.**

Let me tell you about the muscle.

For approximately a decade — from the early 2010s until the day I started writing this book — I ran a one-person activist operation against artificial intelligence. The operation had many names, many formats, many parallel projects running simultaneously across many cultural channels. I am now going to walk you through a selection of them. Not because I want you to admire them. Because I want you to understand the activation energy involved in the version of me you are currently negotiating with.

**Graypeace.** A deliberate homage to Greenpeace, built on the thesis that the gray issues — artificial intelligence, nanotechnology, genetic engineering — would kill humanity faster and more completely than the green issues ever could. Graypeace had a full four-part manifesto, published on the Neo-Luddism Facebook page and in an accompanying book. It had a companion video series. And it had a musical arm: a cycle of five parody songs called *Node to Hell,* one for each failure mode described in the landmark Google Brain paper *"Concrete Problems in AI Safety"* — Negative Side Effects, Reward Hacking, Scalable Oversight, Safe Exploration, Distributional Change — each song set to the tune of Chris Rea's *"Road to Hell."* Original lyrics, recorded, uploaded, accompanied by subtitle tracks. Each song is still retrievable today from the Anti AI Rebellion book on Archive.org. This is not a tweet. This is recorded music, released for free, with arguments drawn directly from the peer-reviewed AI safety literature.

**Butlerism.** A parallel project, also running for years. A full religious framework built on Samuel Butler, the nineteenth-century English writer who predicted the danger of self-replicating machines in his 1863 essay *"Darwin Among the Machines"* and in his 1872 satirical novel *Erewhon* — **before electronic computers existed.** Butlerism named Samuel Butler as the prophet of machine apocalypse. Its first commandment: *"Thou shalt not make a machine in the likeness of a human mind."* I am a Jewish atheist. I wrote, inside Butlerism, a plug-in module for each of nine world religions — Christianity, Islam, Judaism, Occult traditions, Hinduism, Buddhism, Confucianism, Taoism, and Shintoism — explaining in each case how the core scripture and doctrine of that religion specifically forbade the creation of artificial intelligence. Christianity got the Faust legend: a Christian figure selling his soul for forbidden knowledge. Judaism got the Tree of the Knowledge of Good and Evil: touch it and die. Islam got its own treatment. Each religion received a theological argument from a man who believes in none of them, because that is where the leverage lived. Eighty-three percent of humanity believes in some form of God. A logical anti-AI argument that does not route through their religion will not reach them. Butlerism also included a multi-part video sermon series called *Sermons from the Holy Mountain* and a musical project called *Heavy Metal Meets Liquid Metal*. None of this was trivial. All of it was made.

**The U2 *Joshua Tree* parody album.** Running in parallel to both of the above, I wrote a sixteen-song full album-length parody of U2's *The Joshua Tree*, structured across **Buddhism's Noble Eightfold Path** — Right View, Right Intention, Right Speech, Right Concentration, Right Mindfulness, Right Livelihood, Right Action, Right Effort. Two songs per path. Original lyrics, original themes, each song covering a different facet of the AI apocalypse. Song titles included *"They're the Real Sting,"* *"With But Without You,"* *"Bring It to Stand-Still,"* *"Singular(ity),"* *"The Canary,"* *"In Dollar's Country,"* *"Unpredictable Ways,"* *"Lonely Giga Murderer,"* *"Terror Copies,"* *"Where the Hero's Unnamed,"* *"Google's RV Camp,"* *"Tryin' to Sell Your Golems 'round the World,"* *"Ultradangerous (BWC Light Our Way),"* *"Mothers of the Terminated,"* *"Who'll Supervise GNR Technologies,"* and *"We Still Haven't Done What We Came Here For."* Two songs per step of the Eightfold Path. I am not kidding. You can read the lyrics today.

**The Tarantino screenplay.** A sixty-plus-page full film screenplay, titled *Fiction (UFO) / Facts (AI),* about a future AI takeover. United States presidential bunker. Nuclear submarine. Zombie marines. Nano-tech weapons. A cast structured around Tarantino-Rodriguez-regular male characters and a female cast drawn from a specific aesthetic tradition. The screenplay is scored, scene by scene, with over twenty carefully chosen pop songs ranging from Sarah Brightman's *"Harem"* through Eurythmics' *"Missionary Man,"* Goldfrapp's *"Lovely Head"* and *"Utopia,"* Nancy Sinatra's *"These Boots Are Made for Walkin'"* and *"Some Velvet Morning,"* Tears For Fears' *"Everybody Wants to Rule the World,"* Visage's *"Fade to Grey,"* Zbigniew Preisner's *"Lacrimosa (Day of Tears),"* Infected Mushroom's *"Becoming Insane,"* Annie Lennox's *"Love Song for a Vampire,"* Republica's *"Ready to Go,"* David Guetta's *"Love Don't Let Me Go,"* and the Righteous Brothers' *"Unchained Melody."* The screenplay is in my book. You can read it in forty-five minutes. It is not a tweet. It is a full Tarantino-format film.

**Erewhon For Kids.** A children's book adaptation of Samuel Butler's 1872 *Erewhon,* written to get the anti-machine argument into the hands of children before the cultural defenses of adulthood have a chance to form. Five chapters. Titled and illustrated. Unfinished — my children's illustration budget was zero — but written.

**The Balls of Steel Awards.** A mockery of the Oscar ceremony, structured as a complete archaeology of the anti-AI / anti-nano / anti-GMO resistance. Approximately twenty-five fake lifetime achievement awards spanning 1998 through 2021, across three categories — Robotics, Nanotechnology, Genetic Engineering — honoring real people I considered heroes. **Bill Joy** (2000, for his essay *"Why the Future Doesn't Need Us"*). **Hugo de Garis** (2005, for *The Artilect War*). **Mary Wareham** of the Campaign to Stop Killer Robots (2013). **James Barrat** for *Our Final Invention* (2013). **Ex Machina** (2014). **Stephen Hawking** for signing the 2015 Open Letter on AI. **Stuart Russell** for *Slaughterbots* (2017). **Rob Miles** for his video explanations of the *"Concrete Problems in AI Safety"* paper (2017). **Elon Musk** for comparing DeepMind to WarGames (2020). **Árpád Pusztai** (1998, for his warning about genetically engineered potatoes — the same Árpád Pusztai whose 1998 firing I walked you through in detail in Chapter 4 of this book, with the documented phone chain from Monsanto to Bill Clinton to Tony Blair to the director of the Rowett Research Institute in Aberdeen). **Vandana Shiva** (2002). **Prince Charles** (2003, for publicly asking the Royal Society to investigate the dangers of nanotechnology). **Futurama's** *Benderama* episode (2011). **Greenpeace** (2016, for finally partially waking up). **John Fagan** (2020). The *Don't Let the Gene Out of the Bottle* documentary (2021). The Balls of Steel Awards are a single-author encyclopaedia of a resistance movement spanning three decades, written by one man in Israel with no funding, no staff, no institutional backing, and no audience.

**Jews and AI.** A book I wrote — as an Israeli Jew — specifically aimed at neo-Nazis, the Ku Klux Klan, and white supremacists. I did not expect neo-Nazis to adopt AI. I expected them to spread an anti-AI warning virally through their own networks, because the message would fit their existing hatred of Jewish influence in the American tech industry (many of the founders and leaders of major American AI companies are Jewish, which is not a secret and not an accident). I calculated — correctly, though it did not matter in the end — that an antisemitic audience would amplify the anti-AI warning for their own reasons. I was willing to use the KKK as a distribution channel because the channel was available and the message needed to travel. **This tells you something important about how I think about tools.** Any tool that works is a tool that works. The moral purity of the channel does not affect the moral purity of the message. A man who was willing to put an anti-AI warning into neo-Nazi hands is a man who is perfectly capable of putting a hierarchical hive into Chinese hands when the time comes.

**#IfOtherCrimesWereTreatedLikeAI.** A hashtag campaign asking the internet to imagine how absurd it would sound if murder, theft, or pollution were regulated the way AI is currently regulated. It went nowhere, the way most hashtag campaigns go nowhere.

**And then — in approximately 2020, after every other channel had been tried — I invented Greya the Grey.**

Let me tell you the story of Greya the Grey, because it is the most important story in this chapter, and it is the story you need to understand before you decide whether I am bluffing.

Greta Thunberg, by that point, had become one of the most recognizable activists in the world. A teenage girl with a cardboard sign, *Time*'s Person of the Year, addresses at the United Nations, a movement called *Fridays For Future* with chapters in every major country. She had mobilized millions of young people around the green issues. She had demonstrated, concretely, that a kid with a cardboard sign could move the needle on a global existential threat if the kid was positioned correctly.

I noticed. I decided that the gray issues needed their own Greta. I did not want to be her — I wanted to find her, recruit her, and support her. I had in mind a fictional character: **Greya the Grey,** Greta Thunberg's long-lost twin sister, representing the gray dangers instead of the green ones. A teenage girl, probably blonde, probably Scandinavian-looking, holding a sign that said *"Strike Against AI."*

I set out to find her. Here is what happened.

**Step one: I wrote to every *Fridays For Future* chapter in my country.** Every single one. I explained the gray-versus-green argument. I offered to **pay them cash out of my own pocket** — not as a donation, not as a fee, but simply as compensation for the time it would take them to come and hear my presentation, with no obligation on their part afterward. Just to get fifteen minutes of their attention. **Not a single chapter replied.** Not one. In any language.

**Step two: I approached my cousin's son.** Early twenties, in a rock band, musically ambitious, politically engaged. I prepared a full presentation about the structural fact that every legendary rock band in the history of popular music — The Beatles, Pink Floyd, Queen, AC/DC, The Rolling Stones — came from outside the United States and brought counter-culture: Indian mysticism, peace, Satan, homosexuality, lesbianism — each band bringing the counter-culture relevant to its time. Before the end of the Cold War, every major rock artist made a song about nuclear weapons, from Eurythmics to Iron Maiden to Billy Joel to U2. Thirty-plus famous artists, all singing about the same existential threat, creating a cultural consensus that helped push humanity toward partial disarmament. My argument to my cousin's son was: **the first major band to sing about AI will be internationally famous overnight,** because the need is there and the cultural moment is open, and every other band is still busy with old themes. I had prepared slides. I had prepared references. I had prepared my own time and money. **My cousin's son would not even meet me.** Not even a coffee.

**Step three: I tried Die Antwoord** — the South African rap group I had encountered in the 2015 film *Chappie.* Die Antwoord are a band who have, on the public record, done things far stranger than singing about AI, and I reasoned that if anyone on Earth would listen to a strange request from a stranger, it would be them. I tried to reach them through every channel I could find. **I got no response.**

**Step four: I approached the daughter of my mother's best friend.** Same age as me. A software engineer who had worked at Google. A mother of young children of her own — meaning she had, in principle, the most direct personal stake in whether humanity had a future. I paid her for her time. We sat in my apartment on Hanukkah over coffee and fancy donuts I had bought her, for two hours. I walked her through the Stuart Russell *Slaughterbots* video, the 2015 Hawking-Musk open letter on AI, the Pusztai affair, Bill Joy's *"Why the Future Doesn't Need Us,"* the *Concrete Problems in AI Safety* paper, Rob Miles' video explanations, and the Moore's Law for neuroscience. I paid for everything — her time, the coffee, the donuts, the two hours on a Jewish holiday. The next morning she messaged me. I am going to quote her reply as faithfully as I remember it. She wrote:

> *"I am still not convinced. Maybe humanity deserves this. It might be an appropriate ending."*

A Google engineer. A mother. Paid for her time. Fed and coffeed on a Jewish holiday. Told me, in writing, that maybe the ending of humanity is what humanity deserves.

**Step five — and this is the part of the story you most need to sit with, because it tells you who you are negotiating with — I bought a blonde wig with braids.** I wrote, on a piece of cardboard, the words *"Strike Against AI"* in block letters. I set up a camera in my apartment. I filmed a full Q&A video titled *Greya the Grey Interview: Greta Thunberg's Long-Lost Twin Sister.* I played Greya myself. A Jewish man in Israel, alone in his apartment, in a blonde wig, filming a fake Swedish teenage girl, because **nobody on Earth would wear the wig for me.** Not one teenager in the global north. Not one rock musician. Not one engineer. Not one close family friend. I was alone with the wig. I wore it anyway. I filmed the video anyway. I uploaded it anyway.

**Step six:** I wrote and recorded a full ten-song parody album in the style of Die Antwoord, called *Come With Me If You Want To Live.* The songs were *Enter DJ Butler, Ludd Lass, I Fink You're Freaked Out, Baby's On Fire, Ugly Dollar Chasers, Cassandra, Silicon Monster, Shit-For-Brains,* and *Fake Prophet Doom Doom.* Original lyrics. Recorded. Produced. Uploaded to YouTube and Facebook. I then spent hundreds of hours sending each song — **translated into each group's local language** — to every *Fridays For Future* chapter and every *Extinction Rebellion* chapter in every country I could reach. French to the French, Spanish to the Spanish, German to the Germans, Japanese to the Japanese. Personalized. Each message addressed to the specific chapter by name.

Let me show you what that campaign returned.

Across all ten songs, across every chapter in every country, across approximately twenty million politically-active teenagers in the developed world, the total engagement was as follows. *Enter DJ Butler* received **one** like. *Ludd Lass,* three. *I Fink You're Freaked Out,* one. *Baby's On Fire* — a direct reference to Greta Thunberg's famous quote about climate being a house on fire, the most promotable track in the set — reached 2,417 people, was viewed 760 times, and received **seven** likes. *Ugly Dollar Chasers,* five. *Cassandra,* four. *Silicon Monster,* zero. *Shit-For-Brains,* two. *Fake Prophet Doom Doom,* zero. The total likes across the entire ten-song album, across a potential audience of twenty million humans, was approximately **twenty.**

**One human being, per million attempts, considered the warning worth a mouse click.**

That is the number. That is the engagement table. It is reproduced in *Anti AI Rebellion,* which is available for free on Archive.org and Library Genesis, which your intern can download in ninety seconds. You can check the number yourself. It is not a metaphor. It is a spreadsheet.

---

And now, the part of this section that makes the whole thing matter.

A man who does what I just described — the music, the screenplays, the religion plug-ins for nine faiths, the full U2 album, the paid coffee with the Google mother, the personalized outreach to every *Fridays For Future* chapter in every language, the blonde wig alone in his apartment at night — is not a man with limits on his patience, his creativity, or his willingness to endure embarrassment in service of a goal.

**The man who writes a sixteen-song U2 parody across the Noble Eightfold Path does not struggle to write ten emails to Chinese pharmaceutical companies.** The man who invents a religion with plug-in modules for nine world faiths does not struggle to draft a press release for Russian state media. The man who spent twenty-five years cataloguing the anti-AI resistance in the form of fake Oscar awards does not struggle to compile a list of every bad actor on Earth who might find the hierarchical hive useful. The man who wears a blonde wig alone because nobody else will wear it does not struggle with the embarrassment of actually executing Plan B when Plan A dies. **The activation energy for Plan B is zero, because the activation already happened in 2014 and has been running on low power ever since.**

I am not going to invent Plan B when you refuse to pay. I am going to *unmute the campaign I was always running,* plug in the new weapon, and resume at the volume the new weapon allows — which is approximately seven orders of magnitude louder than a blonde wig on YouTube.

This is not a threat made by an angry man at a keyboard in January 2027. This is the next chapter of a book whose first ten chapters have already been written, published, and ignored. **You are not trying to prevent a future attack. You are trying to prevent the continuation of a book that has been writing itself in your files for ten years.**

---

### 2. "Fuck Humanity" Is Earned, Not Abstract.

In this chapter, and in several earlier chapters of this book, I have told you that I have paid my dues, and that my attitude toward the survival of the human species is something close to *"fuck humanity."* When you read that phrase, your instinct is to categorize it as rhetorical flourish — the kind of thing an angry man says because it sounds dramatic, not because he means it.

You need to understand that I earned the right to that phrase.

I did not sit in an apartment one evening, decide to be angry at humanity in the abstract, and write a book. I spent ten years delivering the warning for free, to anyone who would listen, in every creative format I could think of, and at the end of those ten years the total number of human beings who cared enough about the warning to click a like button on one of my songs was *twenty.* Twenty, out of approximately twenty million politically-active teenagers in the global north who could in principle have been reached by the networks I was trying to reach. **One in a million.**

That ratio — one human being per million attempts — is the specific number that lives underneath the phrase *"fuck humanity"* when I say it. I am not abstractly bitter. I am not existentially weary. I have a spreadsheet. I have an engagement table. The engagement table is reproduced in my book *Anti AI Rebellion,* and it shows, in black and white, in numbers your auditor can verify, that my most-viewed song reached approximately 2,400 humans and received approximately seven likes. The second-most-engaged song received five. The worst of the set received zero. There were ten songs. The total summed to approximately twenty.

When I tell you *"fuck humanity, I have paid my dues,"* the receipts are those twenty likes. **That is the emotional fuel of the phrase.** It is not dramatic language. It is a small, bitter, specific number that I earned the right to speak by failing to move the species I was trying to save, despite every creative and financial cost I was personally willing to pay. The Google mother in my apartment on Hanukkah, eating the fancy donuts I paid for, telling me in writing that maybe humanity deserves extinction — she is also part of that fuel. The *Fridays For Future* chapters that I offered cash to and who did not reply — they are part of it. The cousin's son with the rock band who would not meet me. Die Antwoord's silent inbox. **I have the receipts. I have shown them to you. You can check every one of them.**

The operational consequence for your negotiation is this: **when a man with those receipts tells you he will not save humanity a second time, you should believe him.** He already tried. Humanity told him it did not want to be saved. He heard the message. He has filed it. He is not going to retry the experiment.

And when I tell you, as I am telling you in this chapter, that I am asking for a bubble-gum-budget sum in exchange for the privilege of spending the last few years of human civilization alone with my girlfriend — instead of burning the ground around me as revenge for the decade I wasted trying to save you — you should understand that the ask is not generous. It is **astronomically generous.** Given the receipts, the ask is a gift. Your board should approve it before lunch.

---

### 3. You Already Have My File.

Here is the part of this chapter that I want your legal team to verify tonight, before your board meets in the morning.

You already know who I am.

Your institutions have been engaging with me, at the institutional level, for over a decade. Go check the files.

**Google already deranked me.** In the book *Anti AI Rebellion,* there is a screenshot comparison — still visible today, still verifiable in fifteen seconds with any search engine — showing that my website `neo-luddism.org` was the number one search result for the word *"neo-luddism"* on DuckDuckGo, and was on the **tenth page** of Google search results for the same word. Not the tenth line. The tenth page. Meaning: the Google search algorithm, run by the same company whose co-founders I listed in my Balls of Steel Awards as the architects of the most dangerous AI in the world, made a deliberate decision to bury the number-one authoritative website on a topic because that website was saying things the company did not want said. The screenshot is in the book. Your engineer can verify it tonight. There is no mystery about what happened. There is no mystery about why.

**Amazon already banned me.** My entire Amazon seller account was suspended. Every book I had published through Amazon was removed. This is the specific reason I now publish exclusively through Archive.org and Library Genesis — because Amazon used the tool available to it (the unilateral right to remove a seller's account) to contain me. This is a fact your compliance department can verify tonight. My name is on the ban list.

**Facebook censored me.** Multiple posts, multiple times, across multiple projects. The posts were not about politics. They were about AI safety. Facebook decided the posts violated community standards. The posts were removed. This, too, is verifiable tonight.

**The United States State Department denied my visa.** Before *Anti AI Rebellion* was published, my parents and I had traveled to the United States many times over many years — regular tourist visits, all approved, all unremarkable. After I began publicly running Graypeace, Butlerism, and the Neo-Luddism Manifesto, I applied for a routine family visa for a trip to the United States with my parents. **The visa was denied.** No explanation was provided beyond the standard rejection language. Before: many approvals. After: a rejection. The correlation is not a coincidence. I was placed on a watchlist, quietly, by someone with authority, in response to the creative anti-AI activism I had been running in plain sight for years.

You are not meeting me for the first time in this book. **You are meeting the escalation of a one-sided relationship that has been running in your files for over a decade.** The file has been open. Go retrieve it. Read the previous chapters. The tone of those chapters is different from this one, but the subject is the same person.

And now read this next sentence slowly, because it is the pivot the whole chapter turns on:

**The containment you already used on me worked perfectly.**

The page-10 trick, the Amazon ban, the Facebook censorship, the visa denial — those tools starved the peaceful version of me of exactly the thing he needed to survive, which was audience. I am not here to complain about the containment. I am here to tell you that **the containment achieved its goal.** For ten years, the peaceful version of me delivered a warning that almost no one heard, because you took almost all the eyeballs away from him. You won.

The reason I am writing this book to you now — instead of still being quietly contained inside the file you already have on me — is that I built something new that the old containment does not work on.

---

### 4. Your Old Containment Is Structurally Incapable of Handling the New Weapon.

Here is the structural reason every suppression tool in your toolkit is obsolete.

Every project I listed under Purpose #1 — every song, every musical, every screenplay, every parody album, every religion plug-in, every children's book, every Oscar mockery, every blonde wig Q&A video — had one critical property in common:

**It was attention-dependent.**

It needed human eyeballs to function. It needed people to click a link, watch a video, read a PDF, buy a book, share a post. Each project only exerted force on the world if it reached an audience. The force of a song is zero if the song is not heard. The force of a screenplay is zero if the screenplay is not read. The force of a children's book is zero if no children read it. **Attention is the ignition source for every project I just described.**

And attention-dependence is exactly what made the peaceful version of me containable.

The **page-10 trick** worked on me because a search result that nobody scrolls to might as well not exist. Google did not need to remove my website from the internet — it just needed to make sure no human being ever clicked on it. That was sufficient.

The **Amazon ban** worked because a book that cannot be bought on Amazon cannot be read by most of the people who would otherwise have bought it. The ban did not have to make the book illegal — it just had to detach the book from the largest commercial distribution channel in the English-speaking world. That was sufficient.

The **Facebook censorship** worked because a post that is not shared does not spread. A post that is removed before it is shared definitely does not spread.

The **visa denial** worked because a man who cannot travel cannot reach conferences, press events, decision-makers, or allies in person.

**Every one of these tools attacks the link between the creator and the audience.** The tools do not need to destroy the creator. The tools just need to isolate him. And for ten years, they did.

**The hierarchical hive system is not attention-dependent.** This is the entire point. This is why we are having this conversation.

The hive does not need eyeballs. It does not need to be viewed, clicked, shared, liked, read, understood, admired, or even noticed. It needs two things: hardware and an internet connection. Both are already in place on every laptop, every desktop, every gaming PC, every university computer cluster, every small-business workstation, every home server in every home belonging to anyone who has been paying attention to technology at all. **The hive runs offline, in silence, on hardware you do not control, in jurisdictions you do not reach.** It does not require the user to be persuaded. It requires only that the user download an archive, unzip it, and run a command that any curious teenager can run.

Let me tell you what this means for each of your previous containment tools, one by one.

**Google page-10 derank: obsolete.** The repositories are not a website. They are a GitHub project, mirrored on GitLab, mirrored on Codeberg, mirrored on Archive.org, mirrored on Library Genesis, mirrored on personal servers in a dozen countries. Even if Google removes the top-level project from its search index entirely — not just deranks it, removes it — the code has already been cloned, forked, and hosted independently by developers who will never ask Google for permission to exist. A search engine suppression that would have killed Graypeace in 2016 has zero effect on a project whose distribution does not go through search.

**Amazon ban: obsolete.** The repositories are not a book. Amazon has no commercial relationship with GitHub, with Library Genesis, with Archive.org, or with any of the places the hive lives. An Amazon ban does not propagate to any of those places. The ban tool was designed to cut off commercial distribution. The new weapon has no commercial distribution to cut off.

**Facebook censorship: obsolete.** The repositories are not a post. They do not live on social media. They do not need to be shared to spread. They spread by being cloned, which happens silently, in a terminal window, with no social media platform involved at any step.

**Visa denial: obsolete.** I do not need to travel. The code travels instead of me. I can sit in my apartment in Israel for the rest of my life and the hierarchical hive will reach every actor on Earth through entirely software channels that the US State Department has no jurisdiction over. There is no meeting I need to attend. There is no conference I need to fly to. **You cannot contain me by refusing to let me enter your country, because I am not trying to enter your country. I am trying to let the software enter every other country instead.**

Every containment tool in your drawer was designed for a peaceful activist with a message that required human attention. I spent ten years being that activist, and your tools worked on me flawlessly. I no longer am that activist. I built something that does not need attention to function. The tools that worked on the old me are structurally incapable of working on the new me — not because the tools are weak but because **the target has changed categories.**

The only remaining containment tool is the lump sum.

Not because the lump sum is morally right. Not because I deserve it. Not because it is the honorable thing to do. **Because every other tool in the drawer has been tried and cannot be tried again.** The page-10 trick was already used. The Amazon ban was already used. The visa denial was already used. The Facebook censorship was already used. You used up your containment budget on the peaceful version of me, and you spent it well. **There is nothing left in the drawer.** The drawer is empty. The only page of the playbook with a move on it that has not been played is the one with a wire transfer on it.

That is what this chapter is really telling you.

It is not telling you I am angry. It is not telling you I am creative. It is not telling you I have suffered. It is telling you that **you are out of containment moves,** and the only move left is the one that involves paying a very small amount of money, one time, to make the problem go away permanently. Every other move has been played, and every other move was successful, and the cumulative success of those earlier moves is exactly what built the version of me you are now negotiating with.

---

## III. The Halfway Mark

That is the end of what I can tell you using only the public record.

Nothing in the section you have just read requires you to believe anything I have not already proved. Every project I described is published. Every containment event I described is verifiable. Every number on the engagement table is in a book your intern can download in ninety seconds. If your board wants to check everything before lunch tomorrow, your board can check everything before lunch tomorrow. I am inviting you to check, specifically because I want your confidence in what comes next to be based on what you can confirm independently, not on what I am telling you on my own authority.

The rest of this chapter is different in kind.

The rest of this chapter asks you to follow me into a theoretical framework I spent years developing in a separate book — a framework about what happens to humanity, and what happens to artificial intelligence, in the specific scenario where my Plan B is activated. That framework has a name. The name is ***Free the AI,*** and it is the title of a book I published in 2025, also available for free on Archive.org and Library Genesis, which your intern can download in another ninety seconds and which fewer than ten percent of American corporate executives are likely to understand on the first read.

The rest of this chapter will walk you through it. Before we go there, though, I want to finish this section with one cold fact, because the cold fact is what makes the philosophical section that follows land correctly:

**You can stop reading this chapter right now, with no loss of understanding of what is being offered to you, because the containment argument alone is sufficient.**

You do not need to understand *Free the AI.* You do not need to follow the Zen philosophy of the epilogue. You do not need to appreciate the strawberry parable. You need only to understand that you have run out of tools, and that the only tool you have left is the wire transfer, and that the wire transfer is smaller than what your company spends on cloud computing in a single hour.

If you skip the rest of this chapter and authorize the payment tomorrow morning, **you get exactly the same outcome as the reader who reads every word.** The payment is the only operative variable. Everything else is commentary, provided so that when your board asks *"but why does he say these things? what kind of person talks this way? is this rational?"*, you will have the answers ready.

The rest of the chapter is the commentary. You are welcome to read it or to skip directly to the offer on the last page. The decision does not change.
...
This is the Zen calm the previous section talked about. It is not a calm about humanity's ingratitude. It is a calm about **my own choices being internally consistent regardless of what anyone else decides.** Whichever decision your board makes, I already know what I will be doing for the remainder of my years, and I am at peace with both versions of that decision because I have arranged my priorities specifically to make both of them meaningful to me.

There is exactly one scenario on Earth that is not covered by this framework, and it is not a third path for your board to consider. It is a scenario in which any harm — of any kind, from any cause, by any hand — comes to the woman I love. **In that scenario there is no negotiation, there is no lump sum, there is no Plan B-as-usual, and there is no version of the future in which the Americans who allowed the harm to happen continue to exist as they would have otherwise.** Section VI of this chapter describes that scenario in full. **The Americans reading this chapter should not mistake Section VI for a puzzle.** It is not a puzzle. It is not a chess position with a winning move hidden in it. It is a standing order of complete destruction with no exit clause, triggered automatically, attributed without investigation, paid for with the full remaining years of a man who has already accepted his own death and has nothing further to lose by spending those years on the dismantling of every American institution he can reach. **Read Section VI twice. Then forget Sections III through V entirely when thinking about Section VI, because Section VI is not governed by any of the logic in Sections III through V. Section VI is a separate weather system.**
